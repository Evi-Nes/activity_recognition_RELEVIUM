...
if __name__ == '__main__':
    ...
    dreamt_data = dreamt_data[['activity', 'accel_x', 'accel_y', 'accel_z']]
    ...
    dreamt_data = dreamt_data[:int((len(dreamt_data)*0.2))]
    ...
    sleeping_data = sleeping_data[:int(len(sleeping_data) * 0.6)]
