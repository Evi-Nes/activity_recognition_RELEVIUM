...
combined_df.to_csv('combined_unfiltered_dreamt_25Hz.csv', index=False)

# Extract just the acceleration columns and convert to numpy array
combined_df = pd.read_csv('combined_unfiltered_dreamt_25Hz.csv')
